...
| vse                                            | String   | URL for your preferred [Virtual Staging Environment](https://amplience.com/docs/development/virtual-staging.html) within Dynamic Content. This will be used for sending any visualizations to GlobalLink for translations context. |
...
| apiUrl                                         | string   | API URL for the GlobalLink Connect Cloud API.<br /><br />The current version of the GlobalLink Dashboard extension is compatible with with v3 (https://connect-dev.translations.com/rest-api/v3). |
